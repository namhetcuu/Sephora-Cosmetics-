...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/css/iconfont.min.css')}}">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-md-3 col-6 order-lg-1 order-md-1 order-1">
                            <div class="logo">
                                <a href="index.html"><img src="{{('public/frontend/images/logo.png')}}" alt="logo ')}}TG shop"></a>
                            </div>
                        </div>
                        <!--Logo end-->
                        ...
                        <div
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li><a href="{{URL::to('/trang_chu')}}">Home</a>
                                    </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="tf-element-carousel section" data-slick-options='{
                        ...
                        <div class="brand col"><a href="#"><img src="{{('public/frontend/images/brands/brand-1.png')}}" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="{{('public/frontend/images/brands/brand-2.png')}}" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="{{('public/frontend/images/brands/brand-3.png')}}" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="{{('public/frontend/images/brands/brand-4.png')}}" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="{{('public/frontend/images/brands/brand-5.png')}}" alt=""></a>
                        </div>
                    </div>
                    <!--Brand Slider end-->
                </div>
                ...
                <div class="container">
                    <div class="row row-25">
                        ...
                        <div class="footer-widget col-lg-3 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
                            ...
                            <ul class="address">
                                <li><i class="fa fa-home"></i><span>Quang Nam,Da Nang,
                                        Vietnam</span>
                                </li>
                            ...
                            <div class="payment-box mt-15 mb-15">
                                <a href="#"><img src="{{('public/frontend/images/payment.png')}}" alt=""></a>
                            </div>
                        </div>
                        <!--Footer Widget end-->
                    </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-4">
                            <div class="footer-logo text-right">
                                <a href="index.html"><img src="{{('public/frontend/images/logofoo.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
